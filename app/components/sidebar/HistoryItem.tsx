        ...
        {editing ? (
          <form onSubmit={handleSubmit} className="flex-1 flex items-center gap-2">
            ...
            <button
              ...
              className="i-ph:check h-4 w-4 text-gray-500 hover:text-purple-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/70 rounded"
    ...
    return (
      <WithTooltip tooltip={toolTipContent} position="bottom" sideOffset={4}>
        <button
          ...
          className={`text-gray-400 dark:text-gray-500 hover:text-purple-500 dark:hover:text-purple-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500/70 rounded ${icon} ${className ? className : ''}`}
          onClick={onClick}
        />
      </WithTooltip>
    );
